 ...
 */
/* Compiler settings for DllRegExt.idl:
...
#ifndef __DllRegExt_i_h__
#define __DllRegExt_i_h__
...
#ifndef __IDllRegEx_FWD_DEFINED__
#define __IDllRegEx_FWD_DEFINED__
typedef interface IDllRegEx IDllRegEx;
...
#ifndef __DllRegEx_FWD_DEFINED__
#define __DllRegEx_FWD_DEFINED__

#ifdef __cplusplus
typedef class DllRegEx DllRegEx;
#else
typedef struct DllRegEx DllRegEx;
#endif /* __cplusplus */
...
#ifndef __IDllRegEx_INTERFACE_DEFINED__
#define __IDllRegEx_INTERFACE_DEFINED__

/* interface IDllRegEx */
/* [unique][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IDllRegEx;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("425695e9-8f6f-416c-afcb-c824d795c65b")
    IDllRegEx : public IDispatch
    {
    public:
    };
    ...
    interface IDllRegEx
    {
        CONST_VTBL struct IDllRegExVtbl *lpVtbl;
    };
...
#define IDllRegEx_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IDllRegEx_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IDllRegEx_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IDllRegEx_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IDllRegEx_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IDllRegEx_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IDllRegEx_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 
...
/* library DllRegExtLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_DllRegExtLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("c0444687-aa57-4638-8140-1602aa6eef73")
CompReg;
#endif

EXTERN_C const CLSID CLSID_DllRegEx;
